...
CREATE TABLE `tbl_purchase_item` (
  ...
  `lastupdate_date` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=tis620 COLLATE=tis620_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-08-31 16:53:00
