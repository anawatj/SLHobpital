<%-- 
    Document   : tabMotorItem
    Created on : Sep 1, 2015, 6:31:28 PM
    Author     : Tao
--%>
...
<table class="table table-bordered table-hover table-condensed grid">
    ...
    <tbody>
        <tr ng-repeat="item in model.motors">
            <td>
            ...
            <td>
                <select class="form-control" ng-model="item.equipment.id">
                    ...
                    <option ng-repeat="sitem in motors" ng-selected="sitem.id==item.equipment.id" value="{{sitem.id}}">{{sitem.desc}}</option>
                </select>
            </td>
            <td>
    ...
    <tfoot>
        <tr>
            <td colspan="7">
                <button class="btn btn-default" ng-click="addMotor()">Add</button>
                <button class="btn btn-default" ng-click="delMotor()">Del</button>
            </td>
        </tr>
    </tfoot>
</table>