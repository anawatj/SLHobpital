<%-- 
    Document   : entry
    Created on : 21-Aug-2015, 16:38:16
    Author     : anawatj
--%>
...
<tiles:insertDefinition name="defaultTemplate">
    <tiles:putAttribute  name="body">
        <div class="col-xs-12" ng-controller="customerEntryCtrl" ng-init="init()">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3 form-group">
                            <div class="radio-inline">
                                <input type="radio" ng-model="model.customerType" value="P" name="customerType" checked/>
                                <label>บุคคลธรรมดา</label>
                                
                            </div>
                            <div class="radio-inline">
                                <input type="radio" ng-model="model.customerType" value="C" name="customerType"/>
